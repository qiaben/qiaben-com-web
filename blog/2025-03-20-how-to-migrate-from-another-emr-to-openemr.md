...
- **No license fees: [OpenEMR](https://qiaben.com/what-is-openemr-benefits-features-setup-guid/)** has no installation cost.
...
Every EMR uses different field names. Therefore, you must map each field from your old system to its matching field in [OpenEMR.](https://www.open-emr.org/) This process is known as **data mapping**.
