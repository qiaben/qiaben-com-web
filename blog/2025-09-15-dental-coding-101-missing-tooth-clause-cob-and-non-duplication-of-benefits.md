...
The missing tooth clause helps shield [insurance companies](https://www.deltadental.com/) from the cost of pre-existing conditions. Without it, individuals would purchase insurance after losing a tooth, have a costly replacement, and then drop their coverage.
...
In other words: your secondary plan will not pay anything if your [primary](https://qiaben.com/what-is-primary-dental-insurance-and-how-does-it-work/) already paid out an amount of or more than what the secondary would have covered.
...
1. Check benefits in advance. Always call or go online to review clauses prior to treatment.
2. Inform patients. Discuss their responsibility before they get in the chair.
3. Get CDT codes right. Incorrect codes = denials. Always verify the procedure with the right code.
4. Document rules of COB. In case a patient has two coverages, maintain clean records of which plan is primary.
5. Get claims submitted properly. Include narratives, X-rays, or period charts if necessary.
