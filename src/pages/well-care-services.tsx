...
const whyCards = [
  {
    ...
    title: 'Well-Care Coordination',
    desc: 'Make preventive screenings, prompts, and check-ins part of a smooth and forward-looking system that keeps patients active and well.',
  },
  {
    img: '/img/uploads/2024/07/Untitled-design-22.png',
    tag: 'Qiaben Healthcares',
    title: 'Patient Education & Outreach',
    desc: 'Engage patients in effective health education and communication by empowering them in a clear and friendly manner to build trust, awareness and improved self-care practices.',
  },
  {
    img: '/img/uploads/2024/07/Untitled-design-23.png',
    tag: 'Qiaben Healthcares',
    title: 'Personalized Follow-Up Care',
    desc: 'Provide mindful, personalized, post-visit follow-ups and follow-up, affirming treatment plans and enhancing patient-provider relationships.',
  },
];
      ...
      <div className={styles.page}>
            ...
            <Reveal>
              <div>
                <p className={styles.introLead}>
                  Our Patient Well-Care Services at Qiaben are aimed at patient loyalty and an improvement of
                  overall health. We provide long-term patient engagement through active outreach, education,
                  preventive care coordination and individualized follow-ups. This holistic method enables
                  practices to foster sustainable relationships with patients, enhance health results, and
                  demonstrate thoughtful and caring care that can put your clinic and your patients on the road to
                  lifelong wellness.
                </p>
                <div className={styles.introImage}>
                  <img
                    src={useBaseUrl('/img/uploads/2025/08/Additional-Patient-Photos-2.webp')}
                    alt="Nurse reviewing well-care records with an elderly patient"
                    loading="lazy"
                  />
                </div>
              </div>
        ...
        <section className={styles.whySection}>
          ...
          <div className={styles.sectionInner}>
            <Reveal>
              <h2 className={styles.whyTitle}>&ldquo;Comprehensive Patient Well-Care by Qiaben&rdquo;</h2>
            </Reveal>
